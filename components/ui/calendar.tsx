...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "flex space-x-[3px] space-y-0",
        month: "space-y-4 p-4",
        ...
        day_selected:
          "bg-slate-700 text-slate-50 hover:bg-slate-700 hover:text-slate-50 focus:bg-slate-700 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
